...
public class EditCallAction extends BaseEditAction implements Preparable {
    ...
    private IBaseService<Call1> baseService;
     ...
     */
    private Collection<ChangeLog> changeLog(Call1 originalCall, Call1 call) {
        Collection<ChangeLog> changeLogs = null;
        if (originalCall != null) {
            ActionContext context = ActionContext.getContext();
            Map<String, Object> session = context.getSession();
            String entityName = Call1.class.getSimpleName();
    ...
    public String sendInvites() throws Exception {
        ...
        call = baseService.getEntityById(Call1.class, call.getId());
    ...
    public String selectTemplate() throws Exception {
        UserUtil.permissionCheck("update_call");
        call = baseService.getEntityById(Call1.class, this.getId());
        Date start_date = call.getStart_date();
        SimpleDateFormat dateFormat = new SimpleDateFormat(
                Constant.DATE_TIME_FORMAT);
        startDate = "";
    ...
    public String get() throws Exception {
        if (this.getId() != null) {
            ...
            this.getBaseInfo(call, Call1.class.getSimpleName(),
    ...
    public String massUpdate() throws Exception {
        ...
        if (fieldNames != null) {
            ...
            Collection<Call1> calls = new ArrayList<Call1>();
            ...
            for (String IDString : selectIDArray) {
                ...
                Call1 callInstance = this.baseService.getEntityById(Call1.class,
                        id);
                Call1 originalCall = callInstance.clone();
     ...
     */
    private Call1 saveEntity() throws Exception {
        Call1 originalCall = null;
        if (call.getId() == null) {
            UserUtil.permissionCheck("create_call");
        } else {
            UserUtil.permissionCheck("update_call");
            originalCall = baseService.getEntityById(Call1.class, call.getId());
    ...
    public IBaseService<Call1> getbaseService() {
        return baseService;
    }

    public void setbaseService(IBaseService<Call1> baseService) {
     ...
     *            the call to set
     */
    public void setCall(Call1 call) {
        this.call = call;
    }

...
public class ListCallAction extends BaseListAction {
    ...
    private static final String CLAZZ = Call1.class.getSimpleName();
    ...
    public String list() throws Exception {
        ...
        SearchResult<Call1> result = baseService.getPaginationObjects(CLAZZ,
                searchCondition);
        Iterator<Call1> calls = result.getResult().iterator();
     ...
     */
    public static void getListJson(Iterator<Call1> calls, long totalRecords,
    ...
    public String relateCallLead() throws Exception {
        call = baseService.getEntityById(Call1.class, id);
    ...
    public String delete() throws Exception {
        ...
        baseService.batchDeleteEntity(Call1.class, this.getSeleteIDs());
        return SUCCESS;
    }
    ...
    public String copy() throws Exception {
        ...
        if (this.getSeleteIDs() != null) {
            ...
            for (int i = 0; i < ids.length; i++) {
                String copyid = ids[i];
                Call1 oriRecord = baseService.getEntityById(Call1.class,
                        Integer.valueOf(copyid));
                Call1 targetRecord = oriRecord.clone();
    ...
    private InputStream getDownloadContent(boolean isTemplate) throws Exception {
        ...
        try {
            ...
            if (!isTemplate) {
                ...
                for (int i = 0; i < ids.length; i++) {
                    String id = ids[i];
                    Call1 call = baseService.getEntityById(Call1.class,
                            Integer.parseInt(id));
    ...
    protected String getEntityName() {
        return Call1.class.getSimpleName();
    }

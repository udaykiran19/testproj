...
/*        LeadStatus status = this.getLeadStatusService().findByName(
        ...
        LeadStatus status = (LeadStatus) this.getLeadStatusService().findByHQL("FROM LeadStatus L WHERE L.value = 'New'").get(0);
        System.out.println("Lead Status: " + status.getValue() + " " + status.getId());

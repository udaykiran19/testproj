...
public class EditContactAction extends BaseEditAction implements Preparable {
    ...
    private IBaseService<Call1> callService;
    ...
    private Contact saveEntity() throws Exception {
        ...
        if ("Opportunity".equals(this.getRelationKey())) {
            ...
            Call1 call = callService.getEntityById(Call1.class,
                    Integer.valueOf(this.getRelationValue()));
            Set<Call1> calls = contact.getCalls();
            if (calls == null) {
                calls = new HashSet<Call1>();
            }
            calls.add(call);
     ...
     */
    public IBaseService<Call1> getCallService() {
        return callService;
    }
     ...
     */
    public void setCallService(IBaseService<Call1> callService) {
